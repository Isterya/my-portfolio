      ...
      <div className="policy">
        <div className="policy-container">
          ...
          <p>
            ...
            or interact with Isterya | Web Developer — an individual offering
            web development services (such as landing pages, e-commerce sites,
          ...
          <p>
            Isterya | Web Developer is operated by an individual (not a
            registered company), based in Poland, providing freelance and
            contract-based web development services.
          </p>
          <p>
            Contact:{' '}
          ...
          <p>
            If you're located in the European Economic Area (EEA), I process
            your data under these legal bases:
          </p>
          <ul>
          ...
          <p>
            I may update this Privacy Policy from time to time. The latest
